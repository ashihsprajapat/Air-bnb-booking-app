                        ...
                        <div key={index} className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200 hover:shadow-md transition-shadow">
                            {booking.listingImage ? (
                                <img 
                                    ...
                                    alt={booking.listingTitle || 'Booking'} 
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-start gap-2 mb-2">
                                    ...
                                    <div>
                                        <p className="text-gray-600 text-sm">
                                            {booking.checkIn ? new Date(booking.checkIn).toLocaleDateString() : 'Check-in date not set'} 
                                            {' '} to {' '}
                                            {booking.checkOut ? new Date(booking.checkOut).toLocaleDateString() : 'Check-out date not set'}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-2 mb-4">
                                    ...
                                    <p className="text-gray-600 text-sm">
                                        Booked on {booking.bookingDate ? new Date(booking.bookingDate).toLocaleDateString() : 'Unknown date'}
                                    </p>
                                </div>
